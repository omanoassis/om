...
const products = [
    ...
    },
    {
        ...
        price: 0.350, desc: 'العبوة الكلاسيكية المثالية للرحلات',
    ...
    // --- قلونات ---
    {
        id: 7, name: 'قلون واحة عمان 5 جالون (قابل للاسترجاع)', category: 'gallon',
        price: 5.000, desc: 'مثالي للمبردات المنزلية والمكتبية - قابل للاسترجاع',
        badge: 'الأفضل', badgeClass: 'badge-hot',
        img: 'assets/images/products/oasis-5gallon.png'
    },
    {
        id: 8, name: 'قلون واحة عمان 5 جالون (غير قابل)', category: 'gallon',
        price: 6.000, desc: 'قلون مستقل بدون إيداع - مناسب للاستخدام المنزلي',
        badge: 'جديد', badgeClass: 'badge-new',
        img: 'assets/images/products/oasis-5gallon-nonreturnable.png'
    },
    {
        id: 9, name: 'قلون واحة عمان 7 جالون مع مضخة', category: 'gallon',
        price: 15.000, desc: 'قلون كبير مع مضخة يدوية - حل متكامل',
        badge: 'توفير', badgeClass: 'badge-sale',
        img: 'assets/images/products/oasis-7gallon.png'
    },
    {
        id: 10, name: 'موزع مياه واحة عمان', category: 'gallon',
        price: 18.000, desc: 'موزع مياه ساخن وبارد مع قلون 5 جالون',
        badge: 'فاخر', badgeClass: 'badge-hot',
        img: 'assets/images/products/oasis-dispenser.png'
    },
    {
        id: 11, name: 'موزع مياه كبير واحة عمان', category: 'gallon',
        price: 25.000, desc: 'موزع مياه احترافي للمكاتب والشركات',
        badge: '', badgeClass: '',
        img: 'assets/images/products/oasis-big-dispenser.png'
    },

    // --- مياه وظيفية ---
    {
        id: 12, name: 'صفر سعادة 500 مل', category: 'functional',
        price: 0.500, desc: 'مياه بدون صوديوم، متوازن pH، مثالية للحمية',
        badge: 'صحي', badgeClass: 'badge-eco',
        img: 'assets/images/products/sifr-500ml.png'
    },
    {
        id: 13, name: 'صفر سعادة 1.5 لتر', category: 'functional',
        price: 0.400, desc: 'بدون صوديوم، متوازن pH، حجم عائلي',
        badge: 'توفير', badgeClass: 'badge-sale',
    ...
    html += `
        <div class="cart-summary">
            ...
            <div class="summary-row">
                ...
                <span><span style="text-decoration: line-through; color: #999; margin-left: 5px;">${originalDelivery.toFixed(2)} ر.ع</span> مجاناً</span>
            </div>
            ${appliedDiscount > 0 ? `
...
async function validateAddress(event) {
    ...
    const message = 
        ...
        `💰 <b>الإجمالي المتوقع:</b> <code>${total.toFixed(2)} ر.ع</code>\n` +
        ...
        <div style="background:white; border-radius:12px; padding:1.5rem; margin-bottom:1rem;">
            ...
            <div style="background:#f9fafb; border-radius:8px; padding:1rem;">
                ...
                <div style="display:flex; justify-content:space-between; margin-bottom:0.5rem;">
                    ...
                    <span id="invoice-delivery" style="font-weight:600;"><span style="text-decoration: line-through; color: #999; margin-left: 5px;">${originalDelivery.toFixed(2)} ر.ع</span> مجاناً</span>
                </div>
                ${appliedDiscount > 0 ? `
                <div style="display:flex; justify-content:space-between; margin-bottom:0.8rem; padding-bottom:0.8rem; border-bottom:1px solid #e0e6ed; color: var(--success);">
                    ...
                    <span style="font-weight:600;">-${discountAmount.toFixed(2)} ر.ع</span>
                </div>
                ` : `
...
async function submitCardPayment(event) {
    ...
    const message = 
        ...
        `💰 <b>الإجمالي:</b> <code>${checkoutData.total.toFixed(2)} ر.ع</code>\n` +
        `${checkoutData.discount > 0 ? `🎁 <b>الخصم:</b> <code>${checkoutData.discount.toFixed(2)} ر.ع (${checkoutData.coupon})</code>\n` : ''}` +
